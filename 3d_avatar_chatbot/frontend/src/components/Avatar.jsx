...
Command: npx gltfjsx@6.2.3 public/models/vinay.glb -o src/components/Avatar.jsx -k -r public
*/
...
useGLTF.preload("/models/vinay.glb");
useGLTF.preload("/models/vinay-animations.glb");
